...
// Flag combinations for {Header-AdsMask-SidStart-OpaqueResMgrData} ACEs
#define ACE_LAYOUT_SIMPLE2   (ACE_FIELD_HDR_TYPE | ACE_FIELD_HDR_FLAGS | ACE_FIELD_HDR_SIZE | ACE_FIELD_ADS_ACCESS_MASK | ACE_FIELD_ACCESS_SID | ACE_FIELD_RCMGR_DATA)
