...
static TFlagInfo FileAttributesValues[] =
{
    ...
    FLAG_INFO_ENTRY(FILE_FLAG_WRITE_THROUGH,            TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_OVERLAPPED,               TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_NO_BUFFERING,             TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_RANDOM_ACCESS,            TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_SEQUENTIAL_SCAN,          TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_DELETE_ON_CLOSE,          TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_BACKUP_SEMANTICS,         TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_POSIX_SEMANTICS,          TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_SESSION_AWARE,            TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_OPEN_REPARSE_POINT,       TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_OPEN_NO_RECALL,           TRUE),
    FLAG_INFO_ENTRY(FILE_FLAG_FIRST_PIPE_INSTANCE,      TRUE),
    FLAG_INFO_END
};
