...
:COPY_EXE_32
PostBuild.exe .\objfre_w2k_x86\i386\%EXE_NAME%.exe %EXE_NAME%.rc /pdb /tools /subsystem4
...
:COPY_EXE_64
PostBuild.exe .\objfre_wlh_amd64\amd64\%EXE_NAME%.exe %EXE_NAME%.rc /pdb /tools
